...
class TekOscStreamInterface(StreamInterface):
    ...
    def __init__(self):
        ...
        self.commands = {
            ...
            CmdBuilder(self.get_curve)
            .escape(":VERBOSE 0;:HEADER 0;:DATA:SOURCE CH")
            .int()
            .escape(";:DATA:START 1;:DATA:STOP 10000;:DATA:ENC ASCII;:DATA:WIDTH 1;:CURVE?")
            .eos()
            .build(),
            CmdBuilder(self.get_x_incr)
            .escape(":DATA:SOURCE CH")
            .int()
            .escape(";:WFMOUTPRE:XINCR?")
            .eos()
            .build(),
            CmdBuilder(self.get_y_mult)
            .escape(":DATA:SOURCE CH")
            .int()
            .escape(";:WFMOUTPRE:YMULT?")
            .eos()
            .build(),
            CmdBuilder(self.get_x_unit)
            .escape(":DATA:SOURCE CH")
            .int()
            .escape(";:WFMOUTPRE:XUNIT?")
            .eos()
            .build(),
            CmdBuilder(self.get_y_unit)
            .escape(":DATA:SOURCE CH")
            .int()
            .escape(";:WFMOUTPRE:YUNIT?")
            .eos()
            .build(),
            CmdBuilder(self.get_x_zero)
            .escape(":DATA:SOURCE CH")
            .int()
            .escape(";:WFMOUTPRE:XZERO?")
            .eos()
            .build(),
            CmdBuilder(self.get_y_zero)
            .escape(":DATA:SOURCE CH")
            .int()
            .escape(";:WFMOUTPRE:YZERO?")
            .eos()
            .build(),
        }
